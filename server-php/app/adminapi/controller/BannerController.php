...
use app\adminapi\lists\BannerLists;
use app\adminapi\logic\BannerLogic;
use app\adminapi\validate\BannerValidate;
...
class BannerController extends BaseAdminController
{
    ...
    {
        $params = (new BannerValidate())->post()->goCheck('delete');
        BannerLogic::delete($params);
